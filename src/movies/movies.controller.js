...
async function list(req, res) {
  const is_showing = req.query.is_showing; // Check  if the Query Parameter "is_showing" is present and if it's true.
  let data = []; // Create an empty array to store the array obtained from the service.
